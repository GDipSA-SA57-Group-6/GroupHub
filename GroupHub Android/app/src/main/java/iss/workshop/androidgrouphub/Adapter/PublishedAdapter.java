...
public class PublishedAdapter extends RecyclerView.Adapter<PublishedAdapter.Viewholder> {
    ...
    @NonNull
    @Override
    public PublishedAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflator = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_published, parent, false);
        return new Viewholder(inflator);
    }

    @Override
    public void onBindViewHolder(@NonNull PublishedAdapter.Viewholder holder, int position) {
