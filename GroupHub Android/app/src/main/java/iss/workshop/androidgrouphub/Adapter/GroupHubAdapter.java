package iss.workshop.androidgrouphub.Adapter;
...
import iss.workshop.androidgrouphub.Activity.MainActivity;
...
public class GroupHubAdapter extends RecyclerView.Adapter<GroupHubAdapter.Viewholder> {
    ...
    @NonNull
    @Override
    public GroupHubAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull GroupHubAdapter.Viewholder holder, @SuppressLint("RecyclerView") int position) {
